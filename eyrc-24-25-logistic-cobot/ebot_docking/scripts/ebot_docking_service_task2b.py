...
<<<<<<< HEAD
        self.threshold_yaw = 0.020  # Angular threshold in radians prev 0.019
        self.threshold_distance = 0.2  # Linear distance threshold in meters) prev 0.1
=======
